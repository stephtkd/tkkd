...
class Order
{
    ...
    public function getHelloAssoSessionId(): ?string
    {
        return $this->helloAssoSessionId;
    }

    public function setHelloAssoSessionId(?string $helloAssoSessionId): self
    {
        $this->helloAssoSessionId = $helloAssoSessionId;
