 ...
 */
final class Version20220411074547 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category_album ADD album_picture_id INT DEFAULT NULL, ADD color VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category_album DROP album_picture_id, DROP color');
    }
}
