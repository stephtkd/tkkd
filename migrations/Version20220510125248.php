 ...
 */
final class Version20220510125248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE api_credentials (id INT AUTO_INCREMENT NOT NULL, refresh_token VARCHAR(5000) NOT NULL, expire_date_refresh_token DATETIME NOT NULL, access_token VARCHAR(5000) NOT NULL, expire_date_access_token DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, created_at DATETIME NOT NULL, reference VARCHAR(255) NOT NULL, hello_asso_session_id VARCHAR(255) DEFAULT NULL, state TINYINT(1) NOT NULL, INDEX IDX_F5299398A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
